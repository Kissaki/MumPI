 ...
 */
	...
	$txt['request_mail_up_subj'] = 'Login Daten';
	$txt['request_mail_up_body'] = 'Du hast deinen Benutzernamen und dein Passwort angefordert.'."\n\n".'Benutzername: %s'."\n".'Neues Passwort: %s';
	$txt['request_mail_p_subj'] = 'Neues Mumble Passwort';
	$txt['request_mail_p_body'] = 'Du hast ein neues Passwort angefordert.'."\n\n".'Neues Passwort: %s';
	$txt['request_mail_u_subj'] = 'Mumble Login Daten';
	$txt['request_mail_u_body'] = 'Du hast deinen Benutzernamen angefordert.'."\n\n".'Benutzername: %s';
