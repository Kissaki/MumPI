 ...
 */
	...
	$txt['request_mail_up_subj'] = 'Информация для входа';
	$txt['request_mail_up_body'] = 'Вы запросили логин и новый пароль.'."\n\n".'Логин: %s'."\n".'Новый пароль: %s';
	$txt['request_mail_p_subj'] = 'Новый пароль Mumble';
	$txt['request_mail_p_body'] = 'Вы запросили новый пароль.'."\n\n".'Новый пароль: %s';
	$txt['request_mail_u_subj'] = 'Информация для входа в Mumble';
	$txt['request_mail_u_body'] = 'Вы запросили логин.'."\n\n".'Логин: %s';
