...
// This setting only becomes active for php-zeroc-ice versions at or above 3.7.
...
// May be values like Murmur_1.3.0_ice37.php (check your MumPI/classes folder).
...
$iceGeneratedMurmurPHPFileName = 'Murmur_1.3.0_ice37.php';
